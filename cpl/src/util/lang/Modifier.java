...
public class Modifier {
	...
	public static String toString(final int modifier) {
		...
		if ((modifier & VOLATILE) != 0) {
			sb.append("volatile ");
		}
		if ((modifier & NATIVE) != 0) {
			sb.append("native ");
		}
		if ((modifier & SYNCHRONIZED) != 0) {
			sb.append("synchronized ");
		}
		if ((modifier & INTERFACE) != 0) {
			sb.append("interface ");
		}
		if ((modifier & STRICT) != 0) {
			sb.append("strict ");
		}
