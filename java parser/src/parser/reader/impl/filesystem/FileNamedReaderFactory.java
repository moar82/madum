...
public enum FileNamedReaderFactory {
	...
	public NamedReader createNamedReaderFromFile(final String sourceFileOrDirectory) {
		...
		return NamedReaderFactory.Instance.createNamedReader(FileTools.Instance
			.getCanonicalPath(file), type);
	}
