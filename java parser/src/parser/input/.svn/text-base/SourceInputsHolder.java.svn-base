...
public abstract class SourceInputsHolder {
	...
	/*
	 * Java Language Specification Version
	 */
	private int JLS = AST.JLS3;
	...
	public SourceInputsHolder setCompilerCompliance(final String compilerCompliance) {
		this.compilerCompliance = compilerCompliance;
		return this;
	}

	public SourceInputsHolder setJLS(final int jLS) {
		this.JLS = jLS;
		return this;
	}
