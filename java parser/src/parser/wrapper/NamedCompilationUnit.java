...
public class NamedCompilationUnit {
	...
	public NamedCompilationUnit(final String javaFilePath,
	...
	public String getCommentContent(final Comment comment,
		...
		return src.substring(comment.getStartPosition(),
	...
	public List<Comment> getLineAndBlockComment() {
		if (this.compilationUnit != null) {
			...
			final List<Comment> comments = this.compilationUnit
					.getCommentList();
			if (comments != null) {
