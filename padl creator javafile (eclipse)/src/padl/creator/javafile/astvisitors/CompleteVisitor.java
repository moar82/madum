...
public class CompleteVisitor extends ExtendedASTVisitor {
	...
	String currentClassQualifiedName = "";
	...
	public void endVisit(final MethodInvocation node) {
		//		System.out.println(" SuperMethodInvocation " + node.toString()
	...
	public void endVisit(final VariableDeclarationStatement node) {
		...
		System.out.println(type.resolveBinding().getQualifiedName());
		super.endVisit(node);
	}
...
//		System.out.println(" Assignement " + node.toString());
...
//				+ MethodInvocationUtils.isInvocationThroughField(node
//					.getLeftHandSide()));
